  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mt-3 mb-5">
      ...
      <div class="input-group w-auto align-items-center border rounded-3">
        ...
        <input type="search" placeholder="搜尋優惠券名稱" class="form-control border-0" v-model="couponSearchBar">
      </div>
...
export default ({
  ...
  methods: {
    ...
    searchCoupons () {
      const matchCoupons = this.coupons.filter(coupon => coupon.title.toLowerCase().includes(this.couponSearchBar.trim().toLowerCase()))
