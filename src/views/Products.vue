    ...
    <div class="container pb-5">
      <div class="row pt-5">
          ...
          <ul class="list-group sticky-top sticky-position">
            <li>
              <a
                ...
                @click.prevent="selectedCategory = ''; this.$route.params.selectedCategory = ''"
        ...
        <div class="col-lg-9">
          <ul class="row">
            <li
              class="card col-md-6 col-lg-3 border-0 mb-4" v-for="item in filterProducts"
              :key="item.id">
              <div class="overflow-hidden position-relative">
                ...
                <div class="ratio ratio-3x4">
                  <img
                    :src="item.imageUrl"
                    :alt="item.title"
                    class="cart-img object-fit-cover card-img-top">
                </div>
